...
#
#    Copyright (C) 2015
#    Comunitea Servicios Tecnológicos All Rights Reserved
            ...
            for rule in items:
                ...
                if rule.base == -1:
                    ...
                    if seller:
                        ...
                        pricelist_ids = self.pool.get('pricelist.partnerinfo').search(cr, uid, [('suppinfo_id', '=', seller.id),('min_quantity','<=',qty_in_seller_uom),('from_date','<=',date)], order="min_quantity DESC, from_date DESC", limit=1)
                        if pricelist_ids:
