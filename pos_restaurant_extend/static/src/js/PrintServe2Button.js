odoo.define('pos_restaurant_extend.PrintServe2Button', function(require) {
    'use strict';
    ...
    class PrintServe2Button extends PosComponent {
        constructor() {
            super(...arguments);
        ...
        async onClick() {
            ...
            for (var i = 0; i < printers.length; i++) {
                if (printers[i].config.name == 'Cocina') {
                    ...
                    var receipt = QWeb.render('Serve2Receipt', { data: data, widget: this });
    ...
    PrintServe2Button.template = 'PrintServe2Button';

    ProductScreen.addControlButton({
        component: PrintServe2Button,
        condition: function() {
            return true;
        },
    });

    Registries.Component.add(PrintServe2Button);

    return PrintServe2Button;
});
