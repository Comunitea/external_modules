    ...
    def action_invoice(self):
        ...
        for rappel in compute_rappel_obj.\
            ...
            if rappel.quantity <= 0:
                continue
            if rappel.move_id:
                raise UserError(_("The rappel %s of %s with period"
                ...
                tax_ids = [Command.set([x.id for x in taxes_ids])]
        ...
        if not invoices:
            raise UserError(_('Any invoice created!'))
