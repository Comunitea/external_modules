...
class StockMoveLine(models.Model):
    ...
    sscc_ids = fields.Many2many(
        'stock.move.line.sscc', 'operation_sscc_rel', 'move_line_id', 'sscc_id')
...
class StockMove(models.Model):
    ...
    def onchange_packing_list_id(self):
        for move in self:
            move.move_line_ids.write({'packing_list_id': move.packing_list_id and move.packing_list_id.id or False})
