...
/* harmony import */ var _index_3476b023_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-3476b023.js */ "./node_modules/@ionic/core/dist/esm-es5/index-3476b023.js");
...
var Toast = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.didPresent = Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionToastDidPresent", 7);
        this.willPresent = Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionToastWillPresent", 7);
        this.willDismiss = Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionToastWillDismiss", 7);
        this.didDismiss = Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionToastDidDismiss", 7);
    }
    /**
    ...
    class_1.prototype.present = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_6__["e"])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position)];
                    case 1:
                        _a.sent();
                        if (this.duration > 0) {
    ...
    class_1.prototype.dismiss = function (data, role) {
        ...
        return Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_6__["f"])(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
    };
    /**
     * Returns a promise that resolves when the toast did dismiss.
     */
    class_1.prototype.onDidDismiss = function () {
        return Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_6__["g"])(this.el, 'ionToastDidDismiss');
    };
    /**
     * Returns a promise that resolves when the toast will dismiss.
     */
    class_1.prototype.onWillDismiss = function () {
        return Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_6__["g"])(this.el, 'ionToastWillDismiss');
    };
    ...
    class_1.prototype.renderButtons = function (buttons, side) {
        ...
        var buttonGroupsClasses = (_a = {
            ...
            _a);
        return (Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: buttonGroupsClasses }, buttons.map(function (b) { return Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: function () { return _this.buttonClick(b); }, part: "button" }, Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "toast-button-inner" }, b.icon &&
            Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-icon" }), b.text), mode === 'md' && Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })); })));
    };
    class_1.prototype.render = function () {
        ...
        var wrapperClass = (_a = {
            ...
            _a);
        return (Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["H"], { style: {
                zIndex: "" + (60000 + this.overlayIndex),
            }, class: Object.assign(Object.assign(Object.assign((_b = {}, _b[mode] = true, _b), Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_7__["c"])(this.color)), Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_7__["g"])(this.cssClass)), { 'toast-translucent': this.translucent }), onIonToastWillDismiss: this.dispatchCancelHandler }, Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: wrapperClass }, Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "toast-content" }, this.header !== undefined &&
            Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "toast-header", part: "header" }, this.header), this.message !== undefined &&
            Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "toast-message", part: "message", innerHTML: Object(_index_3476b023_js__WEBPACK_IMPORTED_MODULE_8__["s"])(this.message) })), this.renderButtons(endButtons, 'end')))));
    };
...
var buttonClass = function (button) {
    var _a;
    return Object.assign((_a = { 'toast-button': true, 'toast-button-icon-only': button.icon !== undefined && button.text === undefined }, _a["toast-button-" + button.role] = button.role !== undefined, _a['ion-focusable'] = true, _a['ion-activatable'] = true, _a), Object(_theme_18cbe2cc_js__WEBPACK_IMPORTED_MODULE_7__["g"])(button.cssClass));
};
