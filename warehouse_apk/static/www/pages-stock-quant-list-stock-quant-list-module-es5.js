...
var StockQuantListPage = /** @class */ (function () {
    function StockQuantListPage(odoo, router, alertCtrl, route, audio, stock, storage) {
        this.odoo = odoo;
        this.router = router;
    ...
    StockQuantListPage.prototype.check_scanner_values = function () {
        var _this = this;
    ...
    StockQuantListPage.prototype.onShowEmitted = function (val) {
...
//# sourceMappingURL=pages-stock-quant-list-stock-quant-list-module-es5.js.map