...
var LocationInfoComponent = /** @class */ (function () {
    function LocationInfoComponent(router) {
        this.router = router;
    }
    LocationInfoComponent.prototype.ngOnInit = function () { };
    LocationInfoComponent.prototype.open_link = function (type, location_id) {
        if (type == 'stock') {
    ...
    LocationInfoComponent.ctorParameters = function () { return [
...
var StockLocationPage = /** @class */ (function () {
    function StockLocationPage(odoo, router, alertCtrl, route, audio, stock) {
        this.odoo = odoo;
        this.router = router;
...
//# sourceMappingURL=pages-stock-location-stock-location-module-es5.js.map