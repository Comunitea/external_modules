...
let MoveLineDetailsListComponent = class MoveLineDetailsListComponent {
    constructor(router, stock, alertCtrl, route) {
        this.router = router;
        this.stock = stock;
...
MoveLineDetailsListComponent.ctorParameters = () => [
...
let MoveLineListComponent = class MoveLineListComponent {
...
MoveLineListComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let PickingInfoComponent = class PickingInfoComponent {
    constructor(router, alertCtrl, stock, route, audio, location, loadingController) {
        this.router = router;
        this.alertCtrl = alertCtrl;
        this.stock = stock;
        this.route = route;
    ...
    force_set_qty_done(move_id, field, model = 'stock.picking') {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.stock.force_set_qty_done(Number(move_id), field, model).then((lines_data) => {
                if (lines_data == true) {
                    console.log("Reloading");
    ...
    force_reset_qties(pick_id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.stock.force_reset_qties(Number(pick_id), 'stock.picking').then((lines_data) => {
                if (lines_data == true) {
                    console.log("Reloading");
                    this.move_lines = false;
                    this.move_line_ids = false;
...
PickingInfoComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"] },
    { type: _services_stock_service__WEBPACK_IMPORTED_MODULE_4__["StockService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let StockPickingPageModule = class StockPickingPageModule {
};
...
let StockPickingPage = class StockPickingPage {
    constructor(odoo, router, alertCtrl, audio, storage) {
        this.odoo = odoo;
        this.router = router;
        this.alertCtrl = alertCtrl;
        this.audio = audio;
...
StockPickingPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-stock-picking-stock-picking-module-es2015.js.map