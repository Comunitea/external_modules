...
/* harmony import */ var _index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-8ac363fb.js */ "./node_modules/@ionic/core/dist/esm-es5/index-8ac363fb.js");
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_6__["a"])(this.delegate, container, component, ['ion-page', 'ion-page-invisible'], this.params)];
                    case 1:
                        _a.element = _b.sent();
                        _b.label = 2;
...
var Nav = /** @class */ (function () {
    ...
    class_1.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["l"])(view.element, _constants_3c3e1099_js__WEBPACK_IMPORTED_MODULE_5__["d"]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    class_1.prototype.postViewInit = function (enteringView, leavingView, ti) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["l"])(view.element, _constants_3c3e1099_js__WEBPACK_IMPORTED_MODULE_5__["b"]);
                Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["l"])(view.element, _constants_3c3e1099_js__WEBPACK_IMPORTED_MODULE_5__["c"]);
                Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["l"])(view.element, _constants_3c3e1099_js__WEBPACK_IMPORTED_MODULE_5__["d"]);
            }
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["t"])(animationOpts)];
                    case 1:
    ...
    class_1.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["l"])(element, _constants_3c3e1099_js__WEBPACK_IMPORTED_MODULE_5__["d"]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(_index_8ac363fb_js__WEBPACK_IMPORTED_MODULE_7__["s"])(element, true);
            }
        }
    };
    ...
    class_1.prototype.onEnd = function (shouldComplete, stepValue, dur) {
        ...
        if (this.sbAni) {
            ...
            if (!shouldComplete) {
                ...
                newStepValue += Object(_cubic_bezier_1d592096_js__WEBPACK_IMPORTED_MODULE_4__["g"])([0, 0], [1, 0], [0.68, 0.28], [1, 1], stepValue)[0];
            }
            else {
                newStepValue += Object(_cubic_bezier_1d592096_js__WEBPACK_IMPORTED_MODULE_4__["g"])([0, 0], [0.32, 0.72], [0, 1], [1, 1], stepValue)[0];
            }
...
var NavLink = /** @class */ (function () {
    ...
    NavLink.prototype.render = function () {
        return (Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_1__["H"], { onClick: this.onClick }));
    };
