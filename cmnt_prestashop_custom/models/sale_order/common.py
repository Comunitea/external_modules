...
class SaleOrde(models.Model):
    ...
    prestashop_state = fields.Many2one("sale.order.state", copy=False)
    prestashop_transaction = fields.Char(copy=False)
...
class PrestashopSaleOrder(models.Model):
    ...
    # todo mig: Revisar si es necesario, y sobreescribir de nuevo adaptado a v16
